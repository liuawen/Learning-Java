 ...
 * 其他方式 如何开启main线程以外的其他线程呢？
 * 继承Thread  or 实现Runnable接口
 * 2、继承Thread类
 * 步骤：
 ...
 * （4）启动线程：start()
 *
 * 编写线程类去继承 java.lang.Thread类
 * 必须重写父类的public void run(){}
 * 在run()中需要编写，你这个线程需要完成的任务。
 * 创建线程类对象
 * 启动线程 start()
 * 3、实现Runnable 接口
...
public class TestThread2 {
    public static void main(String[] args) {
        ...
        //顺序执行 如果my.run()  没 my.start() 干完 再 后面的
